...
export class OptionChainAnalysisComponent implements OnInit {
  ...
  niftyOpeningPrice:number=18250;
  bankNiftyOpeningPrice:number=42300;
  daysLeftToExpiry:number=4;
 ...
 prepareOptionChainDtoListAndSave(data:any,indexType:string)
 {
  ...
  },(err)=>{this.snackBar.open("Some Error Occured while saving data to bacend", "X");
